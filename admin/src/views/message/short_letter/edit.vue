    ...
    <div class="edit-popup">
        ...
        >
            <el-form ref="formRef" :model="formData" label-width="120px" :rules="formRules">
                ...
                <el-form-item label="SECRET_KEY" prop="secret_key" v-if="formData.type == 'ali' || formData.type == 'tencent'">
                    <el-input v-model="formData.secret_key" placeholder="请输入SECRET_KEY" />
                </el-form-item>
                <el-form-item label="APP_KEY" prop="app_key" v-if="formData.type == 'juhe'">
                    <el-input v-model="formData.app_key" placeholder="请输入聚合数据AppKey" />
                    <div class="form-tips">在聚合数据官网申请短信服务后获取</div>
                </el-form-item>
                <el-form-item label="默认模板ID" prop="template_id" v-if="formData.type == 'juhe'">
                    <el-input v-model="formData.template_id" placeholder="请输入短信模板ID" />
                    <div class="form-tips">聚合数据短信模板ID，如：123456</div>
                </el-form-item>
