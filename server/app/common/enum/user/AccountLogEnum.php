...
class AccountLogEnum
{
    ...
    const UM_INC_DISTRIBUTION = 202;
    const UM_INC_ARTICLE_INCOME = 203;
    ...
    const UM_INC = [
        ...
        self::UM_INC_DISTRIBUTION,
        self::UM_INC_ARTICLE_INCOME,
    ];
    ...
    public static function getChangeTypeDesc($changeType, $flag = false)
    {
        $desc = [
            ...
            self::UM_INC_DISTRIBUTION => '分销佣金增加余额',
            self::UM_DEC_RECHARGE_REFUND => '充值订单退款减少余额',
            self::UM_DEC_ARTICLE_BUY => '购买文章减少余额',
            self::UM_INC_ARTICLE_INCOME => '文章收益增加余额',
        ];
        if ($flag) {
            return $desc;
        }
