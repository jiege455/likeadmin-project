        ...
        <el-form label-width="70px">
            <el-card shadow="never" class="!border-none flex mt-2">
                <div class="flex items-end mb-4">
                    <div class="text-base text-[#101010] font-medium">头部设置</div>
                </div>
                ...
                <el-form-item label="显示余额">
                    <el-switch :model-value="content.show_balance" @change="updateContent('show_balance', $event)" :active-value="1" :inactive-value="0" />
                </el-form-item>
                <el-form-item label="显示明细">
                    <el-switch :model-value="content.show_detail_btn" @change="updateContent('show_detail_btn', $event)" :active-value="1" :inactive-value="0" />
                </el-form-item>
            </el-card>
        </el-form>
    </div>
