...
class NoticeEnum
{
    ...
    const MERCHANT_APPLY_CAPTCHA = 105;
    const DISTRIBUTOR_APPLY_CAPTCHA = 106;
    const WITHDRAW_CAPTCHA = 107;
    ...
    const SMS_SCENE = [
        ...
        self::MERCHANT_APPLY_CAPTCHA,
        self::DISTRIBUTOR_APPLY_CAPTCHA,
        self::WITHDRAW_CAPTCHA,
    ];
    ...
    public static function getSceneDesc($sceneId, $flag = false)
    {
        $desc = [
            ...
            self::MERCHANT_APPLY_CAPTCHA => '商家入驻验证码',
            self::DISTRIBUTOR_APPLY_CAPTCHA => '分销员申请验证码',
            self::WITHDRAW_CAPTCHA => '提现验证码',
        ];
    ...
    public static function getSceneByTag($tag)
    {
        $scene = [
            ...
            // 商家入驻验证码
            'SJRZ' => self::MERCHANT_APPLY_CAPTCHA,
            // 分销员申请验证码
            'FXYSQ' => self::DISTRIBUTOR_APPLY_CAPTCHA,
            // 提现验证码
            'TXSQ' => self::WITHDRAW_CAPTCHA,
        ];
        return $scene[$tag] ?? '';
    }
    ...
    public static function getVars($sceneId, $flag = false)
    {
        $desc = [
            ...
            self::MERCHANT_APPLY_CAPTCHA => '验证码:code',
            self::DISTRIBUTOR_APPLY_CAPTCHA => '验证码:code',
            self::WITHDRAW_CAPTCHA => '验证码:code',
        ];
    ...
    public static function getSmsExample($sceneId, $flag = false)
    {
        $desc = [
            ...
            self::MERCHANT_APPLY_CAPTCHA => '您正在申请商家入驻，验证码${code}，切勿将验证码泄露于他人，本条验证码有效期5分钟。',
            self::DISTRIBUTOR_APPLY_CAPTCHA => '您正在申请成为分销员，验证码${code}，切勿将验证码泄露于他人，本条验证码有效期5分钟。',
            self::WITHDRAW_CAPTCHA => '您正在申请提现，验证码${code}，切勿将验证码泄露于他人，本条验证码有效期5分钟。',
        ];
