...
class DecorateDataLogic extends BaseLogic
{
    ...
    public static function pc(): array
    {
        ...
        return [
            ...
            'pc_open' => ConfigService::get('pc_setting', 'pc_open', 1),
            'pc_close_tips' => ConfigService::get('pc_setting', 'pc_close_tips', 'PC端暂未开放，请使用手机访问'),
        ];
    }
     ...
     * @date 2024/3/14 18:13
     */
    public static function setPcOpen($params): bool
    {
        try {
            $pcOpen = isset($params['pc_open']) ? intval($params['pc_open']) : 1;
            $pcCloseTips = isset($params['pc_close_tips']) ? trim($params['pc_close_tips']) : 'PC端暂未开放，请使用手机访问';
            
            ConfigService::set('pc_setting', 'pc_open', $pcOpen);
            ConfigService::set('pc_setting', 'pc_close_tips', $pcCloseTips);
