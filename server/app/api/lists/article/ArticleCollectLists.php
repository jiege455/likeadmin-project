...
class ArticleCollectLists extends BaseApiDataLists
{
    ...
    public function lists(): array
    {
        ...
        a.click_virtual, a.click_actual,a.create_time, c.create_time as collect_time, a.price,a.issue_no";
        ...
        $articleIds = array_column($lists, 'article_id');
        ...
        foreach ($lists as &$item) {
            ...
            foreach ($paidOrders as $order) {
                if ($order['article_id'] == $item['article_id']) {
