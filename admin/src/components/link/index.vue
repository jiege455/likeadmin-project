<template>
    <div class="link flex">
        ...
        <div class="flex-1 ml-4 link-content">
            <shop-pages v-model="activeLink" v-if="LinkTypeEnum.SHOP_PAGES == activeMenu" :active-tab="activeTab" />
            <article-list v-model="activeLink" v-if="LinkTypeEnum.ARTICLE_LIST == activeMenu" />
            <order-list v-model="activeLink" v-if="LinkTypeEnum.ORDER_LIST == activeMenu" />
